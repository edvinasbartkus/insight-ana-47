...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 w-full z-50 transition-all duration-300 ${scrolled ? "py-4 bg-white/80 backdrop-blur-md shadow-sm" : "py-6"}`}>
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <Button variant="outline" className="rounded-full text-sm font-medium hidden sm:inline-flex">
            Log in
          </Button>
